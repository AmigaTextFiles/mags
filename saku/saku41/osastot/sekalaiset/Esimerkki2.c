   ...
   if (Alustus())
   {
      ...
      app   = ApplicationObject,
         ...
         SubWindow,  mainwindow  = WindowObject,
            ...
            WindowContents, VGroup,          /* VGroup tarkoittaa ett‰ seuraavat objektit ryhmitell‰‰n allekain */
               Child, TextObject,            /* Tehd‰‰n olio jossa on teksti‰ */
                  MUIA_Text_Contents, "\33cSAKU",
                  End,
               Child, RectangleObject, End,  /* Mahdollistaa ikkunan koon muuttamisen myˆs pystysuunnassa */
               Child, button = TextObject,   /* TextObjectista voi tehd‰ myˆs nappuloita */
                  MUIA_CycleChain, 1,                       /* Liitt‰‰ olion tabulaattorilistaan */
                  MUIA_Text_Contents, "\33cSiistii!",
                  MUIA_Background, MUII_ButtonBack,         /* Antavat oliolle painikkeen ulkon‰ˆn */
                  MUIA_Font, MUIV_Font_Button,
                  MUIA_Frame, MUIV_Frame_Button,
                  MUIA_InputMode, MUIV_InputMode_RelVerify, /* Tekee objektista interaktiivisen */
                  End,
               End,
            End,
         End;
